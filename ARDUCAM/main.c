...
void setupCamera(ArducamCamera* camera) {
    ...
    //setSharpness(camera, CAM_SHARPNESS_LEVEL_AUTO);


    // Initialize the camera
    begin(camera);
    takePicture(camera, CAM_IMAGE_MODE_VGA, CAM_IMAGE_PIX_FMT_JPG); // redundant takePicture()
}
...
void cameraCaptureAndSaveImage(ArducamCamera* camera) {
    ...
    printf("length is: %ld\r\n", camera->receivedLength); // just making sure length makes sense
